...
void TITULOS()
  ...
  system("cls");
  system("color F1");
  gotoxy(13,5) ; cout <<"CREAR MATRIZ Y DIAGONAL PRINCIPAL";
  gotoxy(20,6);  cout <<"VECTOR DIAGONAL PRINCIPAL" ;
  }
...
int MENU()
  ...
  gotoxy(20,11); cout << "2 - IMPRIMIR MATRIZ Y VECTOR DIAGONAL";
...
void CALCULO(int MATRIZ[10][10], int VECTOR[10], int FIL, int COL)
  ...
  if ( FIL == 0)
    ...
    {
    TITULOS();
    gotoxy(16,9) ; cout << "IMPRIMIR MATRIZ Y VECTOR DIAGONAL" ;
    ...
    F = 14 + FIL;
    gotoxy(10,F); cout << "VECTOR DIAGONAL =";
    gotoxy(30,F);
    for ( K = 0 ; K < N ; K++ )
      cout << VECTOR[K] << "   ";
