...
void CALCULO(int MATRIZ[10][10], int VECTOR[10], int FIL, int COL);
...
void TITULOS()
  ...
  system("cls");
  system("color F1");
  gotoxy(13,5) ; cout <<"CREAR MATRIZ Y SEGUNDA DIAGONAL";
  gotoxy(20,6);  cout <<"VECTOR SEGUNDA DIAGONAL" ;
  }
...
int MENU()
  ...
  gotoxy(20,11); cout << "2 - IMPRIMIR MATRIZ Y SEGUNDA DIAGONAL";
...
void CALCULO(int MATRIZ[10][10], int VECTOR[10], int FIL, int COL)
  ...
  if ( FIL == 0)
    ...
    {
    TITULOS();
    gotoxy(16,9) ; cout << "IMPRIMIR MATRIZ Y SEGUNDA DIAGONAL" ;
    ...
    for ( K = 0 ; K < N ; K++ )
      VECTOR[K] = MATRIZ[K][COL-1-K];

    F = 14 + FIL;
    gotoxy(10,F); cout << "VECTOR SEG. DIAGONAL =";
    gotoxy(35,F);
    for ( K = 0 ; K < N ; K++ )
      cout << VECTOR[K] << "   ";
